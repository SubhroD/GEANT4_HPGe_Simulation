      ...
      fParticleGun(nullptr)
{
  ...
  fParticleGun->SetParticleEnergy(0.66164 * MeV);
}
...
void B4PrimaryGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
  ...
  if (worldBox)
  {
    worldSizeXY = worldBox->GetXHalfLength() * 2.;
  ...
  fParticleGun->SetParticlePosition(G4ThreeVector(x0/2 , y0/2, z0));
